angular.module('tkrekryApp')
    .directive('formErrorList', function() {
        ...
        return {
            ...
            require: '^form',
            template: '<ol class="form-error-list"><li class="form-error-list" ng-repeat="error in errors">{{error}}</li></ol>',
            replace: true,
            transclude: true,
            restrict: 'AE',
            link: function postLink(scope, elem, attrs, ctrl) {
                ...
                var defaultErrorReasons = {
                    ...
                    minlength: 'on liian lyhyt.',
                    maxlength: 'on liian pitkä.',
                    email: 'ei vastaa sähköpostiosoitteelta vaadittua muotoa.',
                    pattern: 'ei vastaa vaadittua muotoa.',
